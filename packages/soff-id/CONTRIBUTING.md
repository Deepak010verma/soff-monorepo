...
- [Contributing to Soff ID](#contributing-to-soff-id)
...
[Soff ID Code of Conduct](CODE_OF_CONDUCT.md).
...
Before you ask a question, it is best to search for existing [Issues](https://github.com/bledxs/soff-monorepo/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. It is also advisable to search the internet for answers first.
...
2. **Clone your fork**: `git clone https://github.com/your-username/soff-monorepo.git`
...
1. Create `src/locales/{code}.ts` with validation functions
2. Export functions: `validate{DOC}`, `format{DOC}`, `clean{DOC}`, `calculate{DOC}CheckDigit`
3. Add tests in `tests/locales/{code}.test.ts`
4. Update `tsup.config.ts` entry points
5. Update `package.json` exports
6. Update README.md with the new locale
...
Example: `feat(locale): add support for Peru`
