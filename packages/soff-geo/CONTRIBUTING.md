...
- [Contributing to Soff Geo](#contributing-to-soff-geo)
...
[Soff Geo Code of Conduct](CODE_OF_CONDUCT.md).
...
1. Create `src/locales/{code}/departments.ts` and `src/locales/{code}/municipalities.ts`
2. Create `src/locales/{code}.ts` exporting the functions
3. Update `tsup.config.ts` entry points
4. Update `package.json` exports
5. Update README.md with the new locale
